...
def insercionElastic():
    ...
    #INSERCIÓN DATOS CLIMA
     #Ruta de la carpeta donde están los CSV (modifica según tu necesidad)
    ...
    # Itera sobre los archivos clima_1.csv, clima_2.csv, ..., clima_15.csv
    for i in range(1, 16):
        archivo = f'clima_{i}.csv'  # Genera el nombre del archivo
